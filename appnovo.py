...
with tab1:
    ...
    plt.grid()
    st.pyplot(f) # para mostrar o código no streamlit

    """
    Analisando o grupo de etnia dos estudantes o grupo C representa a maior proporção de estudantes, representando 31,9% do total.
...
with tab2:
    st.write('### Análise de estudante por gênero ')
...
with tab4:
    st.write('### Análise de desempenho e notas por disciplina')
